...
Example:
	gaussd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "gaussd", "Home directory of the node's daemon configuration")
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		createValMsg, err := stakingtypes.NewMsgCreateValidator(
			...
			stakingtypes.NewCommissionReallocation(sdk.ZeroDec(), sdk.ZeroDec()),
			sdk.OneInt(),
		)
		if err != nil {
			return err
